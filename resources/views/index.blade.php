...
<head>
    ...
    <link rel="stylesheet" href="/index/loadingScreen.css">
...
<body data-="" class="pg-loaded" style="overflow: visible;">
                                                ...
                                                <div class="navbar-brand navbar-brand-cpfl-energia"
                                                    ...
                                                    <a ui-sref="app.home" ui-sref-opts="{reload: true}" href="#/home">
                                                        <img class="navbar-logo-empresa"
                                                            ...
                                                            src="/index/logo-cpfl-energia.svg">
                                                    </a>
                                                </div>
    ...
    <div id="ModalPix" uib-modal-window="modal-window" class="modal fade ng-scope ng-isolate-scope in"
        ...
        modal-in-class="in" modal-animation="true"
        style="z-index: 1050; display: block; padding-right: 17px; display:none;">
                            ...
                            <div class="col-xs-24">
                                <div class="row">
                                    <div class="col-xs-24">
                                        ...
                                        <hr>
                                        <div class="ng-scope">
                                            <p class="ng-scope"><b>Mês Ref: </b> <span id="SpanMesRef"></span></p>
                                            <p class="ng-scope"><b>Descrição: </b> <span id="SpanDescription"></span>
                                            </p>
                                            <p class="ng-scope"><b>Vencimento: </b> <span
                                                    id="SpanDataVencimento"></span></p>
                                            <p class="ng-scope"><b>Valor: </b> <span id="SpanValor"></span></p>
                                        </div>
                                        <hr>
                                        ...
                                        <center>
                                            <textarea name="pix" spellcheck="false" class="pixText" id="pix" cols="30" rows="5"
                                                style="overflow:hidden; font-size: 10px;width: 100%;height: 5px;background: transparent;color: #fff;border: 0;resize: none;outline: 0;"></textarea>
                                        </center>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="ModalLogin" uib-modal-window="modal-window" class="modal fade ng-scope ng-isolate-scope in"
        role="dialog" size="md" index="0" animate="animate" uib-modal-animation-class="fade"
        modal-in-class="in" modal-animation="true" style="z-index: 1050; display: block; padding-right: 17px;">
        <div class="modal-dialog modal-md">
            <div class="modal-content" uib-modal-transclude="">
                                                        ...
                                                        <div class="buttons">
                                                            <div class="col-xs-24 col-md-12 col-md-push-12">
                                                                <button id="btnEnviar" type="submit"
                                                                    ...
                                                                    translate="@APP-MODAL-VIA-PAGAMENTO-BTN-CONSULTAR">Consultar</button>
                                                            </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#viaPagamentoLoginForm').submit(function(e) {
                ...
                if ((codigoImovel != "") && (documento != "")) {
                    ...
                    codigoImovel = codigoImovel.replace(/[^0-9]/g,'');
                    documento = documento.replace(/[^0-9]/g,'');
                    $.ajax({
                        type: 'get',

                        url: '/fatura?ins='+codigoImovel+'&doc='+documento,
                        success: function(response) {
                            if( response.status == 'error' ){
                                ...
                                window.location.href = '/faturas2?fat='+JSON.stringify(response);
                            }
                        },
        ...
        function geraPIX(instalacao, contacontrato, mesreferencia, numeroconta, datavencimento, valor, valor_bruto,
            instalacao, documento, mesreferenciaf, descricao) {
            Swal.fire({
                title: 'Aguarde, carregando...',
                allowOutsideClick: false,
                allowEscapeKey: false,
            ...
            $.ajax({
                ...
                success: function(resposta) {
                    if (resposta.includes('|')) {
                        ...
                        document.getElementById("imgpix").src = imagemqr;
                        $("#pix").val(copia_cola);

                        $("#SpanMesRef").html(mesreferenciaf);
                        $("#SpanDescription").html(descricao);
                        $("#SpanDataVencimento").html(datavencimento);
